...
pathinfovar_dump(cv=$_FILE["cv"]);
var_dump(diplome=$_FILE["dilpome"]);
pathinfo(diplome=$_FILE["diplome"]);

 //Récupérer les extensions
var_dump($filleInfocv);
var_dump($filleInfodiplome);

//Liste des extensions autorisées
$allowecvdextensions= ["pdf", "doc", docx];
$allowediplomedextensions= ["pdf", "doc", docx];

if (in_array($extensioncv, $allowedextension))
...
move_uploaded_file($_FILES["cv"]["temp_name"]);
